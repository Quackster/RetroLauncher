...
on construct me
  ...
  pProjectorSizeHeight = {projector.pProjectorSizeHeight}
            ...
            var projector = new
            {
                ...
                ExternalVariables = GetValue(config, "varsUrl", "http://localhost/v14/external_vars.txt"),
                ExternalTexts = GetValue(config, "textsUrl", "http://localhost/v14/external_texts.txt"),
                MoviePath = GetValue(config, "movieUrl", "http://localhost/v14/habbo.dcr"),
